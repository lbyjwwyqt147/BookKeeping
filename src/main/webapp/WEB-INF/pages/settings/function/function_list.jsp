...
<html>
  <head>
            ...
            <div class="col-md-9">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-list" style="font-size: 18px;"></i>功能列表 </div>
                        <div class="actions">
                       ...
                       <div class="portlet-body">
                            <div class="row">
		                         <div class="col-md-12">
		                             ...
		                             <!-- 数据列表 -->
		                            <table id="functionGrid" class="table table-striped"></table>
    ...
    <script type="text/javascript" src="<%=basePath%>resources/pages/scripts/settings/function/function_list.js"></script>
  </body>
</html>
